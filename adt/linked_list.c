...
int list_is_empty(LIST L) { return (L->next == NULL); }

int list_is_last(position p, LIST L) { return (p->next == NULL); }
...
void list_insert_header(element_type x, LIST L) { list_insert(x, L, L); }
